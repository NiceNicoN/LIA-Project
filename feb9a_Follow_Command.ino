...
void loop() {
  ...
  if (distance <= 20){   //if false that Mommy is less than 20 cm in Front of the Duck, run next line of code.
    ...
    if (distance <= 20){   //if false that Mommy is less than 20 cm to the Right of the Duck, run next line of code.
      ...
      if (distance <= 80){    //if false that the object is less than 80 cm to the Front of the Duck, run next line of code.
        ...
        if (distance <= 100){   //if false that Mommy is less than 100 cm to the Left of the Duck, run next line of code.
